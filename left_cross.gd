...
var animationName="029_sway_l_anm"
var animationNameNotFlor="041_fly_sway_l_anm"
var animationNameRight="030_sway_r_anm"
var animationNameRightNotFlor="042_fly_sway_r_anm"
...
func _physics_process(delta: float) -> void:
	...
	if character.is_action_just_pressed("cross") and (character.is_action_pressed("left") or character.is_action_pressed("right") )  and !character.is_action_pressed("down"):
...
func postIniciar():
	...
	if !isLeft:
		anmName=animationNameRight
	if !character.is_on_floor():
		anmName=animationNameNotFlor
		if !isLeft:
			anmName=animationNameRightNotFlor
